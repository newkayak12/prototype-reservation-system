package com.reservation.rest.menu.find.all
...
import com.reservation.rest.menu.response.FindMenusResponse
...
class FindMenusController(
    ...
    ): ListResponse<FindMenusResponse> =
        ListResponse.ok(
            findMenusUseCase.execute(id).map {
                FindMenusResponse.from(it)
            },
        )
}
