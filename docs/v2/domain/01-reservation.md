...
|------|--------|-----------|-------------|-------------|
| 손님 | `CreateReservation` | Reservation | `ReservationCreated` | → timetable 구독 (SeatHold) |
| — (이벤트) | `ConfirmReservation` ← `PaymentConfirmed` | Reservation | `ReservationConfirmed` | → timetable 구독 (SeatConfirm) |
| — (이벤트) | `FailReservation` ← `PaymentFailed` | Reservation | `ReservationFailed` | → timetable 구독 (SeatRelease) |
