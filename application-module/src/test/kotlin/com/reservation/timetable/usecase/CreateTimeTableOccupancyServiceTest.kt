...
class CreateTimeTableOccupancyServiceTest {
    ...
    @MockK
    private lateinit var acquireTimeTableFairLock: AcquireTimeTableFairLock

    @MockK
    private lateinit var checkTimeTableFairLock: CheckTimeTableFairLock

    @MockK
    private lateinit var unlockTimeTableFairLock: UnlockTimeTableFairLock
    ...
    fun init() {
        ...
        clearMocks(
            ...
            checkTimeTableFairLock,
            unlockTimeTableFairLock,
