...
class ChangeGeneralUserPasswordServiceTest {
    @MockK
    ...
    @SpyK
    private var changeGeneralUserPasswordDomainService = ChangeGeneralUserPasswordDomainService()

    @InjectMockKs
    private lateinit var useCase: ChangeGeneralUserPasswordService
