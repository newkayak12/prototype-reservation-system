...
class AuthenticateSellerUserUseCaseTest {
    @MockK
    private lateinit var authenticateSignInService: AuthenticateSignInService
    ...
    @InjectMockKs
    private lateinit var useCase: AuthenticateSellerUserUseCase
    ...
    inner class Failure {
        ...
        fun `try sign-in with wrong password`() {
            ...
            every {
                authenticateSignInService.signIn(any(), any())
    ...
    inner class Success {
        ...
        fun `try sign-in blocked account but blocking time expired`() {
            ...
            every {
                authenticateSignInService.signIn(any(), eq(rawPassword))
            } answers { callOriginal() }
